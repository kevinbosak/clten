...
-- Created on Wed Jan 20 19:48:58 2016
-- 
;
--
-- Table: access_level
...
CREATE TABLE "access_level" (
  ...
  "required_mets" integer DEFAULT 0 NOT NULL,
  "met_access_level_id" bigint,
...
CREATE TABLE "agent" (
  ...
  "agreed_to_terms" boolean DEFAULT '0' NOT NULL,
...
CREATE TABLE "agent_meeting" (
  "id" serial NOT NULL,
  "initiating_agent_id" bigint NOT NULL,
  "confirming_agent_id" bigint NOT NULL,
  "status" character varying(50) DEFAULT 'proposed' NOT NULL,
  "time_created" timestamp NOT NULL,
  "time_updated" timestamp NOT NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "agent_ids_key" UNIQUE ("initiating_agent_id", "confirming_agent_id")
);
